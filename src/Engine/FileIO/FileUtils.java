...
public final class FileUtils {
    ...
    /**
     * Get a {@link URL} from the given path with the assumption that it ends in
     * a JAR file.
     *
    ...
    /**
     * Get a {@link InputStream} from the given path with the assumption that it
     * ends in a JAR file.
     *
     * @param names list of file paths with the last one being a file and the
     * rest are directories
     ...
     * entry in name is a file, not a directory. In addition, this method does
     * not return a valid path to a JAR file. In order to get a correct path
     * into JAR, refer to
     *
     * @param names list of file paths with the last one being a file and the
     * rest are directories
